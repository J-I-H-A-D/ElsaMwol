...
const array = ['Elsa','Di','Ok','Sed','Friend','Kannappi','Group','Single','Alamb','Bgm','Moodesh','Song','Thyr','Jihad','Ok bie','help','Adi','Anthas','Boss','Pubg','Free Fire','Kali','Kaztro','mention','Hi','Da','Name','Shahul','Bot','bot','song','hlo','Hlo']
array.map( async (a) => {
